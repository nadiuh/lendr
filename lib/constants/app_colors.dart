...
/// Shared color definitions for the Lendr application.
class AppColors {
  AppColors._();
  ...
  static const Color inputBackground = Color(0xFFFBF9F5);

  // Text colors
  static const Color textPrimary = Color(0xFF2D312E);
  static const Color textSecondary = Color(0xFF6E746F);
